...
const NAV_BOTTOM = [
  { id: 'perfil', label: 'Mi perfil', icon: 'perfil', href: '/perfil' },
];
...
export default function AppLayout({ session, currentPage = 'resumen', profileIncomplete = false, children }) {
    ...
    <div className="app-shell">
      ...
      <aside className={`sidebar ${sidebarOpen ? 'open' : ''}`}>
        ...
        <nav className="sidebar-nav" aria-label="Navegación principal">
          ...
          <span className="sidebar-section-label" style={{ marginTop: 'auto', paddingTop: 'var(--space-4)' }}>
            Cuenta
          </span>
          {NAV_BOTTOM.map((item) => {
            ...
            return (
              ...
              >
                ...
                {profileIncomplete && <span className="nav-badge">!</span>}
              </a>
            );
          })}
